...
<div> 
	...
	<form method="post" action=""> 
		...
		<table width="auto" height="auto"align="center" bgcolor="skyblue"> 
			...
			<h3 style="float:left; padding-right:20px;"><a href="customer_register.php" style="text-decoration:none;">New? Register Here</a></h3>
