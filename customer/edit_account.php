...
<form action="" method="post" enctype="multipart/form-data">
					...
					<table align="center" width="750">
						...
						<tr>
							...
							<td><input type="password" name="c_pass" value="<?php echo $pass;?>" disabled required/></td>
						</tr>
...
if(isset($_POST['update'])){
       $ip=get_client_ip();
		...
		move_uploaded_file($c_image_tmp,"customer_images/$c_image");
		 ...
		 $update_c = "update customers set customer_name='$c_name', customer_email='$c_email', customer_city='$c_city', customer_contact='$c_contact',customer_image='$c_image',customer_address='$c_address' where customer_id='$c_id '";
		...
		echo "<script>alert('Account has been updated successfully, Thanks!')</script>";
		...
		echo "<script>alert('Account has not been  successfully updated, Sorry' PLease try again)</script>";
