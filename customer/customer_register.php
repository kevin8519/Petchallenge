...
<div id="content_area">
	...
	<div id="shopping_cart">
		...
		Welcome Guest&nbsp;<b style="color:yellow;">Shopping Cart-</b>Total items:<?php total_items();?>Total Price:<?php total_value();?><a href="cart.php" style="color:yellow">Go to Cart</a>
	</span>
	</div>
