...
<link rel="stylesheet" href="styles/A_green.css" media="all" type="text/css">
<link rel="stylesheet" href="styles/pagination.css" media="all" type="text/css">
...
<div id="content_area">
	...
	$page = (int) (!isset($_GET["page"]) ? 1 : $_GET["page"]);
        ...
        $statement = "pets order by pet_title asc"; //you have to pass your query over here

		$run_pet=mysqli_query($con,"select * from {$statement} LIMIT {$startpoint} , {$limit}");
		while($row_pet=mysqli_fetch_array($run_pet))
		{
		/*echo $row["name"];*/
		
		
	/*$get_pet="select * from pets";
